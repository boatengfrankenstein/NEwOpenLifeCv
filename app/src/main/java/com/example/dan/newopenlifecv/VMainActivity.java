package com.example.dan.newopenlifecv;
...
public class VMainActivity extends Activity implements OnTouchListener, CvCameraViewListener2 {
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    mOpenCvCameraView.setOnTouchListener(VMainActivity.this);
                    // 640x480
                } break;
                default:
                {
